      ...
      <section className="mx-auto w-[min(1180px,92%)] pb-14 pt-14">
          ...
          {PILLARS.map((pillar) => {
            ...
            return (
              <div key={pillar.icon} className="card p-6">
                ...
                <h2 className="font-display mt-4 text-lg font-bold text-[var(--text-primary)]">
                  {content.title}
                </h2>
        ...
        <div className="stagger mt-14 grid gap-5 md:grid-cols-3">
          {STEPS.map((step) => {
            ...
            return (
              <div key={step.number} className="rise-in border-t-2 border-dotted border-[var(--accent)]/50 pt-4">
