...
const en = {
  ...
  'nav.map': 'Crime Map',
  'chrome.statewide': 'Statewide',
  'map.title': 'Crime Density Map',
  'map.subtitle': 'Incident density, emerging hotspots, and the 3-month forecast overlay',
  'map.loading': 'Loading map intelligence…',
  'map.layer.density': 'Density',
  'map.layer.forecast': 'Forecast',
  'map.layer.emerging': 'Emerging hotspots',
  'map.filter.all': 'All crime types',
  'map.legend.forecastNote': 'Dashed circles show the least-squares 3-month forecast per district; red = predicted growth, green = predicted decline.',
  ...
  'overview.alerts.more': 'Full temporal, geographic and forecast views in',
  'overview.resetDemo': '↺ Reset demo data',
  ...
  // Sociology page
  'sociology.title': 'Sociological Intelligence',
  'sociology.subtitle': 'District crime rates correlated with 2011 Census indicators — Module D',
  'sociology.loading': 'Correlating crime data with census indicators…',
  'sociology.caveat.prefix': 'Correlation ≠ causation.',
  'sociology.caveat.body': 'These indicators surface socioeconomic patterns to help prioritise resource allocation and community outreach — not to suggest that Census groups cause crime. All data is 2011 Census (static) joined to the active workspace\'s FIR records.',
  'sociology.correlation.label.literacy': 'Crime rate vs Literacy rate',
  'sociology.correlation.label.urbanisation': 'Crime rate vs Urbanisation rate',
  'sociology.correlation.positive': 'positive correlation',
  'sociology.correlation.negative': 'negative correlation',
  'sociology.correlation.negligible': 'negligible correlation',
  'sociology.correlation.pearson': 'Pearson r across',
  'sociology.correlation.districts': 'Karnataka districts',
  'sociology.profiles.title': 'District socioeconomic risk profiles',
  'sociology.profiles.subtitle': 'Joined from active workspace FIRs + Karnataka Census 2011',
  'sociology.profiles.col.district': 'District',
  'sociology.profiles.col.firs': 'FIRs',
  'sociology.profiles.col.crimeRate': 'Crime / 100k',
  'sociology.profiles.col.literacy': 'Literacy %',
  'sociology.profiles.col.urban': 'Urban %',
  'sociology.profiles.col.socialRisk': 'Social Risk',
  // Analytics — MO serial patterns card (Track A addition)
  'analytics.moCluster.title': 'Modus operandi serial patterns (C4)',
  'analytics.moCluster.subtitle': 'FIR groups sharing an identical modus operandi — potential serial offenders',
  'analytics.moCluster.none': 'No serial MO patterns detected.',
  'analytics.moCluster.cases': 'cases',
  'analytics.moCluster.partOfSeries': 'Part of a series of',
  'analytics.moCluster.seriesSuffix': 'cases sharing the same modus operandi',
  'analytics.moCluster.reviewLinked': 'Review linked cases for serial offender patterns.',
  // Case detail page
  'caseDetail.loading': 'Assembling case intelligence…',
  'caseDetail.serialBanner.label': 'Part of a series of',
  'caseDetail.serialBanner.suffix': 'cases sharing the same modus operandi',
  'caseDetail.serialBanner.cta': 'Review linked cases for serial offender patterns.',
  'caseDetail.summary.title': 'Automated case summary',
  'caseDetail.summary.subtitle': 'Generated from FIR record and linked entities (F1)',
  'caseDetail.summary.occurred': 'Occurred',
  'caseDetail.summary.statusUpdate': 'Update case status (audit-logged)',
  'caseDetail.summary.currentlyPrefix': 'The case is currently',
  'caseDetail.summary.withAccused': 'with',
  'caseDetail.summary.namedAccused': 'named accused',
  'caseDetail.summary.includingRepeat': ', including repeat offenders',
  'caseDetail.summary.moPrefix': 'Modus operandi:',
  'caseDetail.summary.priorCases': 'cases on record',
  'caseDetail.accused.title': 'Accused',
  'caseDetail.accused.empty': 'No accused identified yet.',
  'caseDetail.victims.title': 'Victims',
  'caseDetail.victims.empty': 'No victims recorded.',
  'caseDetail.timeline.title': 'Investigation timeline',
  'caseDetail.timeline.subtitle': 'Chronology of recorded events (F2)',
  'caseDetail.leads.title': 'Suggested investigative leads',
  'caseDetail.leads.subtitle': 'Generated from network and financial links (F4)',
  'caseDetail.similar.title': 'Similar cases',
  'caseDetail.similar.subtitle': 'Matched on modus operandi, crime type and location (F3)',
  'caseDetail.similar.none': 'No similar cases found.',
} as const;
...
const kn: Record<MessageKey, string> = {
  ...
  'nav.map': 'ಅಪರಾಧ ನಕ್ಷೆ',
  'chrome.statewide': 'ರಾಜ್ಯವ್ಯಾಪಿ',
  'map.title': 'ಅಪರಾಧ ಸಾಂದ್ರತೆ ನಕ್ಷೆ',
  'map.subtitle': 'ಘಟನೆ ಸಾಂದ್ರತೆ, ಉದಯೋನ್ಮುಖ ಹಾಟ್‌ಸ್ಪಾಟ್‌ಗಳು ಮತ್ತು 3-ತಿಂಗಳ ಮುನ್ಸೂಚನೆ ಪದರ',
  'map.loading': 'ನಕ್ಷೆ ಗುಪ್ತಚರ ಲೋಡ್ ಆಗುತ್ತಿದೆ…',
  'map.layer.density': 'ಸಾಂದ್ರತೆ',
  'map.layer.forecast': 'ಮುನ್ಸೂಚನೆ',
  'map.layer.emerging': 'ಉದಯೋನ್ಮುಖ ಹಾಟ್‌ಸ್ಪಾಟ್‌ಗಳು',
  'map.filter.all': 'ಎಲ್ಲಾ ಅಪರಾಧ ಪ್ರಕಾರಗಳು',
  'map.legend.forecastNote': 'ಚುಕ್ಕೆ ವೃತ್ತಗಳು ಜಿಲ್ಲೆವಾರು 3-ತಿಂಗಳ ಮುನ್ಸೂಚನೆ ತೋರಿಸುತ್ತವೆ; ಕೆಂಪು = ಏರಿಕೆ ನಿರೀಕ್ಷೆ, ಹಸಿರು = ಇಳಿಕೆ ನಿರೀಕ್ಷೆ.',
  ...
  'overview.alerts.more': 'ಪೂರ್ಣ ಕಾಲಿಕ, ಭೌಗೋಳಿಕ ಮತ್ತು ಮುನ್ಸೂಚನೆ ನೋಟಗಳಿಗೆ ನೋಡಿ:',
  'overview.resetDemo': '↺ ಡೆಮೊ ಡೇಟಾ ಮರುಹೊಂದಿಸಿ',
  ...
  'copilot.response.hideReasoning': 'ತಾರ್ಕಿಕ ಹಾದಿಯನ್ನ ಮರೆಮಾಡಿ',
  ...
  // Sociology page
  'sociology.title': 'ಸಮಾಜಶಾಸ್ತ್ರೀಯ ಗುಪ್ತಚರ ವಿಶ್ಲೇಷಣೆ',
  'sociology.subtitle': 'ಜಿಲ್ಲಾ ಅಪರಾಧ ದರಗಳು 2011 ಜನಗಣತಿ ಸೂಚಕಗಳೊಂದಿಗೆ ಸಹಸಂಬಂಧ — ಮಾಡ್ಯೂಲ್ D',
  'sociology.loading': 'ಜನಗಣತಿ ಸೂಚಕಗಳೊಂದಿಗೆ ಅಪರಾಧ ದತ್ತಾಂಶ ಸಹಸಂಬಂಧಿಸಲಾಗುತ್ತಿದೆ…',
  'sociology.caveat.prefix': 'ಸಹಸಂಬಂಧ ≠ ಕಾರಣತ್ವ.',
  'sociology.caveat.body': 'ಈ ಸೂಚಕಗಳು ಸಾಮಾಜಿಕ-ಆರ್ಥಿಕ ಮಾದರಿಗಳನ್ನು ಬೆಳಕಿಗೆ ತರುತ್ತವೆ — ಸಂಪನ್ಮೂಲ ಹಂಚಿಕೆ ಮತ್ತು ಸಮುದಾಯ ಸಂಪರ್ಕಕ್ಕೆ ಆದ್ಯತೆ ನೀಡಲು. ಜನಗಣತಿ ಗುಂಪುಗಳು ಅಪರಾಧಕ್ಕೆ ಕಾರಣ ಎಂಬ ಸೂಚನೆ ನೀಡುವುದಿಲ್ಲ. ಎಲ್ಲಾ ದತ್ತಾಂಶ 2011 ಜನಗಣತಿ (ಸ್ಥಿರ) ಮತ್ತು ಸಕ್ರಿಯ ಕಾರ್ಯಕ್ಷೇತ್ರದ FIR ದಾಖಲೆಗಳನ್ನು ಜೋಡಿಸಿದ್ದಾಗಿದೆ.',
  'sociology.correlation.label.literacy': 'ಅಪರಾಧ ದರ vs ಸಾಕ್ಷರತಾ ದರ',
  'sociology.correlation.label.urbanisation': 'ಅಪರಾಧ ದರ vs ನಗರೀಕರಣ ದರ',
  'sociology.correlation.positive': 'ಸಕಾರಾತ್ಮಕ ಸಹಸಂಬಂಧ',
  'sociology.correlation.negative': 'ನಕಾರಾತ್ಮಕ ಸಹಸಂಬಂಧ',
  'sociology.correlation.negligible': 'ನಗಣ್ಯ ಸಹಸಂಬಂಧ',
  'sociology.correlation.pearson': 'Pearson r —',
  'sociology.correlation.districts': 'ಕರ್ನಾಟಕ ಜಿಲ್ಲೆಗಳ ಆಧಾರದ ಮೇಲೆ',
  'sociology.profiles.title': 'ಜಿಲ್ಲಾ ಸಾಮಾಜಿಕ-ಆರ್ಥಿಕ ಅಪಾಯ ಪ್ರೊಫೈಲ್‌ಗಳು',
  'sociology.profiles.subtitle': 'ಸಕ್ರಿಯ ಕಾರ್ಯಕ್ಷೇತ್ರ FIRಗಳು + ಕರ್ನಾಟಕ ಜನಗಣತಿ 2011 ಜೋಡಣೆ',
  'sociology.profiles.col.district': 'ಜಿಲ್ಲೆ',
  'sociology.profiles.col.firs': 'FIRಗಳು',
  'sociology.profiles.col.crimeRate': 'ಅಪರಾಧ / 1 ಲಕ್ಷಕ್ಕೆ',
  'sociology.profiles.col.literacy': 'ಸಾಕ್ಷರತೆ %',
  'sociology.profiles.col.urban': 'ನಗರ %',
  'sociology.profiles.col.socialRisk': 'ಸಾಮಾಜಿಕ ಅಪಾಯ',
  // Analytics — MO serial patterns card
  'analytics.moCluster.title': 'ಅಪರಾಧ ವಿಧಾನದ ಸರಣಿ ಮಾದರಿಗಳು (C4)',
  'analytics.moCluster.subtitle': 'ಒಂದೇ ಅಪರಾಧ ವಿಧಾನ ಹಂಚಿಕೊಳ್ಳುವ FIR ಗುಂಪುಗಳು — ಸಾಧ್ಯವಾದ ಸರಣಿ ಅಪರಾಧಿಗಳು',
  'analytics.moCluster.none': 'ಯಾವುದೇ ಸರಣಿ ಅಪರಾಧ ವಿಧಾನ ಮಾದರಿ ಪತ್ತೆಯಾಗಿಲ್ಲ.',
  'analytics.moCluster.cases': 'ಪ್ರಕರಣಗಳು',
  'analytics.moCluster.partOfSeries': 'ಒಂದು ಸರಣಿಯ ಭಾಗ —',
  'analytics.moCluster.seriesSuffix': 'ಪ್ರಕರಣಗಳು ಒಂದೇ ಅಪರಾಧ ವಿಧಾನ ಹಂಚಿಕೊಳ್ಳುತ್ತವೆ',
  'analytics.moCluster.reviewLinked': 'ಸರಣಿ ಅಪರಾಧಿ ಮಾದರಿಗಳಿಗಾಗಿ ಸಂಬಂಧಿತ ಪ್ರಕರಣಗಳನ್ನು ಪರಿಶೀಲಿಸಿ.',
  // Case detail page
  'caseDetail.loading': 'ಪ್ರಕರಣದ ಗುಪ್ತಚರ ಮಾಹಿತಿ ಸಂಗ್ರಹಿಸಲಾಗುತ್ತಿದೆ…',
  'caseDetail.serialBanner.label': 'ಒಂದು ಸರಣಿಯ ಭಾಗ —',
  'caseDetail.serialBanner.suffix': 'ಪ್ರಕರಣಗಳು ಒಂದೇ ಅಪರಾಧ ವಿಧಾನ ಹಂಚಿಕೊಳ್ಳುತ್ತವೆ',
  'caseDetail.serialBanner.cta': 'ಸರಣಿ ಅಪರಾಧಿ ಮಾದರಿಗಳಿಗಾಗಿ ಸಂಬಂಧಿತ ಪ್ರಕರಣಗಳನ್ನು ಪರಿಶೀಲಿಸಿ.',
  'caseDetail.summary.title': 'ಸ್ವಯಂಚಾಲಿತ ಪ್ರಕರಣ ಸಾರಾಂಶ',
  'caseDetail.summary.subtitle': 'FIR ದಾಖಲೆ ಮತ್ತು ಸಂಬಂಧಿತ ಘಟಕಗಳಿಂದ ರಚಿಸಲಾಗಿದೆ (F1)',
  'caseDetail.summary.occurred': 'ನಡೆದ ದಿನಾಂಕ',
  'caseDetail.summary.statusUpdate': 'ಪ್ರಕರಣ ಸ್ಥಿತಿ ನವೀಕರಿಸಿ (ಲೆಕ್ಕಪರಿಶೋಧನಾ ದಾಖಲೆಯಲ್ಲಿ ನಮೂದಾಗುತ್ತದೆ)',
  'caseDetail.summary.currentlyPrefix': 'ಈ ಪ್ರಕರಣ ಪ್ರಸ್ತುತ',
  'caseDetail.summary.withAccused': 'ಜೊತೆ',
  'caseDetail.summary.namedAccused': 'ಹೆಸರಿಸಿದ ಆರೋಪಿಗಳಿದ್ದಾರೆ',
  'caseDetail.summary.includingRepeat': ', ಪುನರಾವರ್ತಿತ ಅಪರಾಧಿಗಳು ಸೇರಿದಂತೆ',
  'caseDetail.summary.moPrefix': 'ಅಪರಾಧ ವಿಧಾನ:',
  'caseDetail.summary.priorCases': 'ಹಿಂದಿನ ಪ್ರಕರಣಗಳು',
  'caseDetail.accused.title': 'ಆರೋಪಿಗಳು',
  'caseDetail.accused.empty': 'ಇನ್ನೂ ಯಾವುದೇ ಆರೋಪಿ ಗುರುತಿಸಲಾಗಿಲ್ಲ.',
  'caseDetail.victims.title': 'ಸಂತ್ರಸ್ತರು',
  'caseDetail.victims.empty': 'ಯಾವುದೇ ಸಂತ್ರಸ್ತರು ದಾಖಲಾಗಿಲ್ಲ.',
  'caseDetail.timeline.title': 'ತನಿಖಾ ಕಾಲಮಾಲೆ',
  'caseDetail.timeline.subtitle': 'ದಾಖಲಾದ ಘಟನೆಗಳ ಕಾಲಾನುಕ್ರಮ (F2)',
  'caseDetail.leads.title': 'ಸೂಚಿತ ತನಿಖಾ ಸುಳಿವುಗಳು',
  'caseDetail.leads.subtitle': 'ಜಾಲ ಮತ್ತು ಹಣಕಾಸಿನ ಸಂಪರ್ಕಗಳಿಂದ ರಚಿಸಲಾಗಿದೆ (F4)',
  'caseDetail.similar.title': 'ಹೋಲುವ ಪ್ರಕರಣಗಳು',
  'caseDetail.similar.subtitle': 'ಅಪರಾಧ ವಿಧಾನ, ಅಪರಾಧ ಪ್ರಕಾರ ಮತ್ತು ಸ್ಥಳ ಆಧಾರದ ಮೇಲೆ ಹೊಂದಾಣಿಕೆ (F3)',
  'caseDetail.similar.none': 'ಯಾವುದೇ ಹೋಲಿಕೆಯ ಪ್ರಕರಣಗಳು ಕಂಡುಬಂದಿಲ್ಲ.',
};
